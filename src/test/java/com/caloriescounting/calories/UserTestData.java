...
import com.caloriescounting.calories.model.AbstractBaseEntity;
import com.caloriescounting.calories.model.Role;
import com.caloriescounting.calories.model.User;
import com.caloriescounting.calories.web.json.JsonUtil;

import java.util.Collections;
import java.util.Date;

public class UserTestData {
   public static TestMatcher<User> USER_MATCHER = TestMatcher.usingFieldsComparator(User.class.toString(), "registered", "meals", "password");
