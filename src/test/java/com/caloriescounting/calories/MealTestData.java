...
public class MealTestData {
    public static TestMatcher<Meal> MEAL_MATCHER = TestMatcher.usingFieldsComparator(Meal.class.toString(), "user");

    public static final int MEAL1_ID = AbstractBaseEntity.START_SEQ + 2;
    public static final int ADMIN_MEAL_ID = AbstractBaseEntity.START_SEQ + 9;
